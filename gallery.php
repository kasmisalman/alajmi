            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="forget_password.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                ...
                <div>
                  <div class="filter-container p-0 row">
                    <div class="filtr-item col-sm-2" data-category="1" data-sort="white sample">
                      <a href="img1.jpg" data-toggle="lightbox" data-title="sample 1 - white">
                        <img src="img1copy.jpg" class="img-fluid mb-2" alt="white sample"/>
                      </a>
                    </div>
                    <div class="filtr-item col-sm-2" data-category="2, 4" data-sort="black sample">
                      <a href="img2.jpeg" data-toggle="lightbox" data-title="sample 2 - black">
                        <img src="img2copy.jpeg" class="img-fluid mb-2" alt="black sample"/>
                      </a>
                    </div>
